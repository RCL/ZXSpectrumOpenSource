...
ENHANCED_ULA_INK_COLOR_MASK_42  equ PALETTE_FORMAT_NR_42
...
; RCL added this on 2024-11-10
INTERRUPT_CONTROL_C0        equ $C0
INTERRUPT_ENABLE_MASK_0_C4  equ $C4
INTERRUPT_ENABLE_MASK_1_C5  equ $C5
INTERRUPT_ENABLE_MASK_2_C6  equ $C6

; RCL added 2024-11-15
TIMEX_MODE_CONTROL_FF       equ $FF
