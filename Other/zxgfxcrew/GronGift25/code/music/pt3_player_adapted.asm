...
PD_LP2	LD A,(BC)
	...
	ADD A,A
	LD E,A
	LD HL,#FFFF & SPCCOMS+#FF20-#2000		;LD HL,SPCCOMS+#FF20-#2000
	ADD HL,DE
	LD E,(HL)
	INC HL
	LD D,(HL)
...
CHREGS	XOR A
	...
	INC A
		;      PT2	PT3
	CP D	;OrnCP CP E	CP D
	JR C,CH_ORPS
	LD A,E	;OrnLD LD A,D	LD A,E
...
CH_NOK	ADD A,A
	...
	LD B,A
	ADD A,A
	ADD A,A ;SamClc2 or ADD A,B for PT2
	LD L,A
	ADD HL,SP
	LD SP,HL
	LD A,B
	INC A
		;      PT2	PT3
	CP D	;SamCP CP E	CP D
	JR C,CH_SMPS
	LD A,E 	;SamLD LD A,D	LD A,E
...
T_PACK	DB #06EC*2/256,#FF & #06EC*2
	DB #0755-#06EC
	DB #07C5-#0755
	DB #083B-#07C5
	DB #08B8-#083B
